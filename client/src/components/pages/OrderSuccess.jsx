    ...
    <div className="bg-[#f3f7fb] min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 text-center mb-6">
          ...
          <div className="bg-gray-50 rounded-md py-3 px-4 inline-block border border-gray-100">
            <span className="text-xs text-gray-400 uppercase font-bold tracking-wider">Reference ID: </span>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4 relative">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Items are being packed</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 relative">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-400">Arriving by {formattedDelivery}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button 
            onClick={() => navigate('/')}
            className="flex-1 bg-[#24aeb1] text-white py-4 rounded-md font-bold text-sm uppercase tracking-widest hover:bg-[#1e8f91] transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
          >
            <ShoppingBag size={18} /> Continue Shopping
          </button>
          <button 
            onClick={() => navigate('/my-orders')}
            className="flex-1 bg-white border border-gray-200 text-gray-700 py-4 rounded-md font-bold text-sm uppercase tracking-widest hover:bg-gray-50 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            Track Orders <ArrowRight size={18} />
          </button>
        </div>
